...
async function main() {
  ...
  for (const versionInfo of ResEdit.Resource.VersionInfo.fromEntries(resources.entries)) {
    versionInfo.setFileVersion(0, 4, 0, 0, 1033);
    versionInfo.setProductVersion(0, 4, 0, 0, 1033);
    ...
    for (const language of targets) {
      versionInfo.setStringValues(language, {
        ...
        FileDescription: "Stock Pet desktop market companion",
        InternalName: "StockPetEnglish",
